...
export default function InvoicePdfDocument({ invoice, items, settings, logoSrc }: { invoice: InvoicePdfData; items: InvoicePdfItem[]; settings: InvoicePdfSettings; logoSrc: string }) {
