    ...
    <article className="productCard">
      <Link className="productImageLink" href={`/produk/${product.slug}/`} aria-label={`Lihat ${product.name}`}>
        <div className="productImageWrap">
          <ProductImage images={product.images} sizes="(max-width: 560px) calc(100vw - 40px), (max-width: 900px) 50vw, 28vw" alt={getProductImageAlt(product)} loading="lazy" fetchPriority="low" />
