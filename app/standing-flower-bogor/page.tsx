...
const description = "Pesan standing flower Bogor dari Biorona Florist Cibinong untuk grand opening, pernikahan, ucapan selamat, dan duka cita. Konsultasi detail dan pengiriman via WhatsApp.";
